...
public class TOGame
{
  ...
  public TOGame(String aName, int aNrLevels, int aNrBlocksPerLevel, int aWidthPlayArea, int aHeightPlayArea, int aMinBallSpeedX, int aMinBallSpeedY, double aBallSpeedIncreaseFactor, int aMaxPaddleLength, int aMinPaddleLength)
  {
    name = aName;
    nrLevels = aNrLevels;
